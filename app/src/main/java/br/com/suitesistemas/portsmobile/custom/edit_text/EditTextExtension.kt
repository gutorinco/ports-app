        ...
        override fun onTextChanged(value: CharSequence?, start: Int, before: Int, count: Int) {
            ...
            if (textLength <= 11) {
                for (index in text.indices) {
                    if (index == 2 && !(backspaceWasPressed && textLength == 3))
                        newValue = newValue + text[index] + "."
                    else if (index == 5 && !(backspaceWasPressed && textLength == 6))
                        newValue = newValue + text[index] + "."
                    else if (index == 8 && !(backspaceWasPressed && textLength == 9))
                        newValue = newValue + text[index] + "-"
                    else
                        newValue += text[index]
                }
                ...
                for (index in text.indices) {
                    if (index == 1 || index == 4)
                        ...
                        newValue = newValue + text[index] + "/"
                    else if (index == 11 && !(backspaceWasPressed && textLength == 12))
                        newValue = newValue + text[index] + "-"
                    else
                        newValue += text[index]
                }
