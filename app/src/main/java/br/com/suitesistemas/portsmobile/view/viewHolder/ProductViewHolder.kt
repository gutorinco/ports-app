...
import kotlinx.android.synthetic.main.fragment_product_adapter.view.*

class ProductViewHolder(private val adapterView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(adapterView) {

    val name = adapterView.product_adapter_name
    val colorName = adapterView.product_adapter_color_name
    val quantity = adapterView.product_adapter_quantity
