...
fun MaterialButton.showProgressSpinner(buttonText: Int) {
    isEnabled = false
    background.setColorFilter(getCustomColor(context, R.color.success_disabled), android.graphics.PorterDuff.Mode.MULTIPLY)
    showProgress {
...
fun MaterialButton.hideProgressSpinner(buttonText: Int) {
    isEnabled = true
    background.setColorFilter(getCustomColor(context, R.color.success), android.graphics.PorterDuff.Mode.MULTIPLY)
